...
class AccountRepository{
  Future<GlobalResponse> getAccountProfile({@required AccountParam params}) async {
    try {
      final http.Response response = await ApiClient().httpPostHelper('/profile', params.toJson(), 'API Profile');
